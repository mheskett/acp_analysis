...
bedtools intersect -f 0.25 -v -a $out_dir$filename.tmp1.plus.bed -b $ref_dir/ucsc.refseq.hg19.txn.whole.gene.chr$chrom.bed > $out_dir$filename.tmp2.plus.bed
...
bedtools coverage -a $out_dir$filename.tmp3.plus.bed -b $ref_dir/ucsc.L1s.hg19.chr$chrom.bed -F 0.9 |
...
bedtools intersect -f 0.25 -v -a $out_dir$filename.tmp1.minus.bed -b $ref_dir/ucsc.refseq.hg19.txn.whole.gene.chr$chrom.bed > $out_dir$filename.tmp2.minus.bed
