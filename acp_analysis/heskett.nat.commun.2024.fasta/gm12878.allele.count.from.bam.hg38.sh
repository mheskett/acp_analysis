...
bcftools mpileup -R /home/exacloud/gscratch/ThayerLab/heskett/acp_analysis/na12878_hg38/NA12878.hets.only.vcf.gz \
...
tail -n +2 $out_dir$filename.table | awk 'OFS="\t"{print $1,$2-1,$2,$3,$4,$5}' |
    ...
    -b /home/exacloud/gscratch/ThayerLab/heskett/acp_analysis/na12878_hg38/NA12878.hets.only.hg38.bed -wa -wb > $out_dir$filename.allele.counts.bed

# bedtools intersect -a stdin -b NA12878.haplotypes.het.nochr.bed -wa -wb
