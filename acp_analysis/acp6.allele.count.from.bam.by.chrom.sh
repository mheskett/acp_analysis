...
chrom=$2
out_dir=$3
#./hg38_1kg_reference_snps/ALL_20141222.dbSNP142_human_GRCh38.snps.chr$chrom.vcf.gz 
bcftools mpileup -R ./acp6_trio/acp6_joint.fb30.chr$chrom.vcf.no.missing.vcf.wh.phased.final.hets.bed \
...
tail -n +2 $out_dir$filename.chr$chrom.table | awk 'OFS="\t"{print $1,$2-1,$2,$3,$4,$5}' |
  bedtools intersect -a stdin -b ./acp6_trio/acp6_joint.fb30.all.chrom.no.missing.wh.phased.final.hets.bed -wa -wb > $out_dir$filename.chr$chrom.allele.counts.bed
