...
whatshap phase \
  --ped /home/exacloud/gscratch/ThayerLab/heskett/acp_analysis/acp7_trio/acp7_pedigree.ped \
  ...
  $input \
  acp7_child.sorted.markdup.chr$chrom.bam \
  acp1005a_mom.sorted.markdup.chr$chrom.bam \
  acp1005b_dad.sorted.markdup.chr$chrom.bam

bcftools view -S acp7_child.txt $out_dir$filename.wh.phased.vcf | \
